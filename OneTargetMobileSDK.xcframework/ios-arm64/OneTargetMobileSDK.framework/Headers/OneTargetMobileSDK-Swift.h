...
#ifndef ONETARGETMOBILESDK_SWIFT_H
#define ONETARGETMOBILESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OneTargetMobileSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

@class ONETARGETConfiguration;

SWIFT_CLASS_NAMED("ObjCAnalytics")
@interface ONETARGETAnalytics : NSObject
- (nonnull instancetype)initWithConfiguration:(ONETARGETConfiguration * _Nonnull)configuration withLaunchOptions:(NSDictionary * _Nullable)launchOptions OBJC_DESIGNATED_INITIALIZER;
...
@interface ONETARGETAnalytics (SWIFT_EXTENSION(OneTargetMobileSDK))
- (void)trackEventWithIdentityId:(NSDictionary<NSString *, id> * _Nonnull)identityId eventName:(NSString * _Nonnull)eventName eventData:(NSDictionary<NSString *, id> * _Nonnull)eventData profile:(NSArray<NSDictionary<NSString *, id> *> * _Nullable)profile;
- (void)trackBash:(NSString * _Nonnull)name properties:(NSDictionary<NSString *, id> * _Nullable)properties;
@end
...
@interface ONETARGETConfiguration : NSObject
